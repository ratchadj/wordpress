...
$yydev_tag_manager_data_plugin_version = '2.3.1'; // plugin version
$yydev_tag_manager_data_slug_name = 'yydev_tag_manager__version'; // the name we save on the wp_options database
